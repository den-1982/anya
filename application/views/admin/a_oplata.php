	...
	<form id="form" action="<?=$path?>" method="POST" enctype="multipart/form-data">
			...
			<table class="table-1">
				<tbody>
					<tr>
						...
						<td>
							<input class="inf" type="text" name="h1" value="<?=$oplata->h1?>">
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:100px;" class="inf" name="title"><?=$oplata->title?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:100px;" class="inf" name="metadesc"><?=$oplata->metadesc?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:100px;" class="inf" name="metakey"><?=$oplata->metakey?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:70px;" class="inf" name="spam"><?=$oplata->spam?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea class="tiny" style="height:300px;" name="text"><?=$oplata->text?></textarea>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="bookmark" data-id="slider">
			<table class="table-1">
				...
				<?php foreach ($oplata->slider as $slide):?>
					<tr data-slider="item">
						<td>
		...
		<input type="hidden" name="id" value="<?=$oplata->id?>">
