	...
	<form id="form" action="<?=$path?>" method="POST" enctype="multipart/form-data">
			...
			<table class="table-1">
				<tbody>
					<tr>
						...
						<td>
							<input class="inf" type="text" name="h1" value="<?=$biznes->h1?>">
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:100px;" class="inf" name="title"><?=$biznes->title?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:100px;" class="inf" name="metadesc"><?=$biznes->metadesc?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:100px;" class="inf" name="metakey"><?=$biznes->metakey?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea style="height:70px;" class="inf" name="spam"><?=$biznes->spam?></textarea>
						</td>
					</tr>
					<tr>
						<td class="small nowrap right">
						...
						<td>
							<textarea class="tiny" style="height:300px;" name="text"><?=$biznes->text?></textarea>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="bookmark" data-id="slider">
			<table class="table-1">
				...
				<?php foreach ($biznes->slider as $slide):?>
					<tr data-slider="item">
						<td>
